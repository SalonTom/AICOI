...
|:-------------------------------:|----------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|          myMoveItPyBot.py          |                   -20                  | Bot using only a QLeraning algorithm to learn the game. Its score is very mediocre as the number of state to visit is very high leading the bot to make very poor choices. A new bot combining a decision tree and QLearning algorithm is coming soon.